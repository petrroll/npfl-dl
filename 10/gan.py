    ...
    def construct(self, args):
        ...
        with self.session.graph.as_default():
            ...
            def generator(z):
                ...
                dense_1 = tf.layers.dense(z, 128, activation=tf.nn.relu)
                flatten_img = tf.layers.dense(dense_1, self.HEIGHT * self.WIDTH, activation=tf.nn.sigmoid)
            ...
            def discriminator(image):
                ...
                logits = tf.layers.dense(dense_1, 1, activation=None)
