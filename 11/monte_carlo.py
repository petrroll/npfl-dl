...
def record_episode(env, args, policy):
    #Reset environment
    episode = []
    episode_reward = 0
...
def do_mc_learning(policy, avgReturn, stateActionSeen, eps, env):
...
if __name__ == "__main__":
    ...
    while training:
        ...
        # Record one episode
        episode, episode_reward = record_episode(env, args, policy)
        ...
        do_mc_learning(policy, avgReturn, stateActionSeen, eps, env)
